...
\begin{figure}[htbp]
  ...
  \begin{subfigure}{0.45\linewidth}
    ...
    \caption{D8}
  \end{subfigure}
  \caption{Flow accumulation as water drains from a circular cone, computed with D-infinity (left) and D8 (right). The D8 method creates artefactual spokes every \(45^\circ{}\), while D-infinity gives a smooth pattern. Figure from \citet{Tarborton97}.}%
  \label{fig:d8}
\end{figure}
