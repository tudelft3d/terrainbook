...
The most widely used modern method to do so is the D\(^{\infty}\) (\citet{Tarborton97}) method, which computes, for each cell, the direction of the steepest descent within the triangular facets formed by the cell and pairs of its neighbouring cells.
