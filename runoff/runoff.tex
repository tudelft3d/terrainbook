...
\caption{A vertical cross-section of a DTM with a filled sink. The dashed line represents the original terrain, whereas the thicker solid line represents the filled terrain; the shaded area is the material added to fill the sink. Based on \citet{Barnes14a}.}%
\label{fig:pf}
\end{figure}
