...
\begin{figure}
	...
	\begin{subfigure}{0.4\linewidth}
		...
		\subcaption{Lidar}\label{fig:acqLidar}
	\end{subfigure}
	\quad
	\begin{subfigure}{0.4\linewidth}
		\includegraphics[width=\textwidth]{figs/photogrammetry.png}
		\subcaption{Photogrammetry}\label{fig:acqPhoto}
	\end{subfigure}
...
\begin{figure}
	...
	\begin{subfigure}{0.4\linewidth}
		...
		\subcaption{Point distribution and occlusion}\label{fig:lidarAcquisitionConditions:a}
	\end{subfigure}
	\quad
	\begin{subfigure}{0.3\linewidth}
		\includegraphics[width=\textwidth,page=1]{figs/lidarAcq.pdf}
		\subcaption{Reflection and multi-path}\label{fig:lidarAcquisitionConditions:b}
	\end{subfigure}
