...
\setchapterpreamble[u]{\youtube[0pt]{youtu.be/\_BSuNu3Ahw0}\margintoc[18pt]}
...
\label{sec:acquisition-techniques}
...
%no texture (shadow), multi-path, complete absorption lighting conditions: shadow poor matching
