...
\begin{marginfigure}
  ...
  \caption{Top: Given a cell $c_{i,j}$, the 3$\times$3 nes its 8 neighbours. Bottom: a hypothetical case with some elevations; orange = aspect for method \#2 below, purple = aspect for method \#3 below.}%
