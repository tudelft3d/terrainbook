...
\begin{marginfigure}
  \centering
  \includegraphics[width=\linewidth]{figs/ahn3-water.png}
  \caption{An aerial point cloud with several canals (dark colour).}%
\labfig{fig:examples1}
\end{marginfigure} 
\begin{marginfigure}
  \centering
  \includegraphics[width=\linewidth]{figs/facade.jpg}
  \caption{A laserscan of a façade containing several windows.}%
\labfig{fig:examples2}
\end{marginfigure} 
