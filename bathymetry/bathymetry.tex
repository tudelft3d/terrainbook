...
Firstly, all the statistically cleaned input sample points of a given area are used to construct a TIN that respects the Delaunay criterion.
...
Finally, contour lines are derived from the altered TIN using linear interpolation~\citep{Watson92}.
