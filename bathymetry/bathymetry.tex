...
\begin{figure*}[b]
  \centering
  \includegraphics[width=0.85\linewidth]{figs/enc_denhelder.jpeg}
...
\index{multibeam echosounders (MBES)}
...
%%%
\section[Practical methods not satisfactory]{Common methods used in practice are not satisfactory}
