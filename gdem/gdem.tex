...
\begin{figure}
  ...
  \caption{OpenTopography coverage with some European datasets added in pink by author(s).} % might be more European datasets
...
To read up on the DGED format, check out \url{https://dgiwg.org/documents/dgiwg-standards}.
