...
\begin{enumerate}
  \item \textbf{Level 1} products contain the raw telemetry;
...
%%%
\paragraph{Comparison to typical airborne lidar.}
...
Some satellites have a polar orbit and can therefore completely measure the Earth (ICESat-2 is one example, see Figure~\ref{fig:orbit}), while some will cover only certain latitudes (\eg\ GEDI, see Figure~\ref{fig:orbit}).
