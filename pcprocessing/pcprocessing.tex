...
For example in case of a point cloud derived from multi-beam echo sounding\footnote{See Section~\ref{sec:acquisistion-techniques}.} a common issue is the occurrence of (shoals of) fish. 
