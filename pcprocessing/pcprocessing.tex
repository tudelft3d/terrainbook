...
In Figure~\ref{fig:csf_2cases} it is 0.5 of the difference in elevation, but if more tension is wanted, then the scale could be for instance 0.4 (so that the movable particle has a displacement $\vec{v}=(0, 0, 3.2)$, because $0.4 * (10-2) = 3.2$) or 0.3.
