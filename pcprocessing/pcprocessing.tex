...
%The computational complexity of RANSAC is $\mathcal{O}(kn)$.
...
%The computational complexity is $\mathcal{O}(nm)$, where m is the number of elements in the accumulator.
