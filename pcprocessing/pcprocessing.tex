...
Observe that the compressed is fully usable as is, that is one does not need to first uncompress the files to extract the points and their attributes (like with ZIP files for instance).
