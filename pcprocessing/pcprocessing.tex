...
Figure~\ref{fig:ground-filtering-example} gives an example result.
\begin{figure*}
  \centering
  \begin{subfigure}[b]{0.45\linewidth}
    \centering
    \includegraphics[width=\textwidth]{filter_before.png}
    \caption{Original point cloud}
  \end{subfigure}
  \quad
  \begin{subfigure}[b]{0.45\linewidth}
    \centering
    \includegraphics[width=\textwidth]{filter_after.png}
    \caption{The ground extract with a ground filter}
  \end{subfigure}
\caption{Ground filtering example.}%
\label{fig:ground-filtering-example}
\end{figure*}
