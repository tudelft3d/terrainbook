...
In Figure~\ref{fig:csf_2cases} it is 0.5 of the difference in elevation, but if more tension is wanted, then the scale could be 0.8 (so that the movable particle has a displacement $\vec{v}=(0, 0, 5.6)$, because $0.8 * (10-2) = 5.6$).
