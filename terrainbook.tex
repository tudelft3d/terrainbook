...
\usepackage[backend=bibtex,natbib=true,style=authoryear,citestyle=authoryear,maxcitenames=2,maxbibnames=10,giveninits=true,isbn=false,doi=false]{biblatex}
...
\graphicspath{{figs/}} % Paths in which to look for images
...
\newcommand{\margintocvideo}[1]{
  \begingroup
    ...
    \marginnote{\localtableofcontents {\parindent -2pt \faVideoCamera\ \url{#1}}}
  \endgroup
}
