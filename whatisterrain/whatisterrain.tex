...
\begin{description}
  \item[DEM] (\textbf{D}igital \textbf{E}levation \textbf{M}odel). In the literal meaning of the term, it is simply a model of the elevation. A DEM is either a DSM or a DTM\@.\marginnote{\faVideoCamera\ \url{https://youtu.be/_BSuNu3Ahw0}}\index{DEM} 
