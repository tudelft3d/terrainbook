...
\end{enumerate}
Observe that, as shown in Figures~\ref{fig:vd2d} and~\ref{fig:dualdetail}, the location of a Voronoi vertex $v^{\star}$ dual to a Delaunay triangle $\tau$ is that the centre of the circumcircle of $\tau$.
This can be obtained

% TODO: finish centre of circumcircle
