...
IDW is a \emph{family} of spatial interpolation methods using distance(s) to identify the neighbours and the weights.
...
\begin{description}
  \item[k-nearest neighbours:] the $k$-nearest neighbours (say being 10 for instance) can be used, irrespective of how far they are. This ensures that IDW will yield a continuous surface. (\reffig{fig:idwvar}b)
