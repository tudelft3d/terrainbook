...
The NNI method can be thought of performing linear interpolation, in the 1D case (where we have one independent variable) then it is equivalent to a linear interpolant.
...
The resulting interpolant is $C^1$, and Figure~\ref{}
\begin{figure}
  \centering
