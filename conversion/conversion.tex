...
\marginnote{The implementation of the DT in \href{https://docs.scipy.org/doc/scipy/reference/generated/scipy.spatial.Delaunay.html}{SciPy} does not allow to delete/remove vertices, but \href{https://www.cgal.org}{CGAL} and \href{https://github.com/hugoledoux/startin}{startin} do.}
