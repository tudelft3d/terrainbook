...
For the DT construction, this can be realised by constructing a quadtree of $S$; a finalisation tag basically informs the following process that a certain cell of the quadtree is empty, that all the points have been processed.
