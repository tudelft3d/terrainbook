...
\marginnote{random process}\index{random process}
...
\marginnote{probability distribution}\index{probability distribution}
...
\marginnote{random variable}\index{random variable}
...
\marginnote{variance}\index{variance}
...
\marginnote{covariance}\index{covariance}
...
\marginnote{correlation coefficient}\index{correlation coefficient}
...
\marginnote{stationarity of the mean}\index{stationarity of the mean}
...
\marginnote{second-order stationarity}\index{second-order stationarity}
...
\marginnote{unbiased}\index{unbiased}
...
\marginnote{minimisation of the variance}\index{minimisation of the variance}
...
\marginnote{simple kriging system}\index{simple kriging system}
...
\marginnote{variogram cloud}\index{variogram cloud}
...
\marginnote{experimental variogram}\index{experimental variogram}
...
\marginnote{theoretical variogram}\index{theoretical variogram}
