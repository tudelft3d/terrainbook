...
(b) With a large nugget, the interpolant smooths the data, and the values in the neighbourhood of the sample points no longer coincide with them.}%
...
The effect of a large nugget is therefore to smooth the interpolant in the neighbourhood of the sample points, rather than to change the value at the sample points themselves (see Figure~\ref{fig:nugget_exactness}).
